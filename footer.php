			...
			<div class="row">
                <div class="col-6 col-md-6 col-lg-3">
                    <div class="short-about">
                        ...
                        <a class="text-white" href="">এটুআই প্রোগ্রাম</a>
                        <br>
                        <p>
                            তথ্য ও যোগাযোগ প্রযুক্তি বিভাগ<br>
                            ই-১৪/এক্স, আইসিটি টাওয়ার<br>
                            আগারগাঁও, শের-ই-বাংলা নগর, ঢাকা- ১২০৭<br>
                            ওয়েবসাইট: a2i.gov.bd
                        </p>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-lg-3">
                    ...
                    <p> ইমেইলঃ <br><span>info@tanagil.com</span></p>
                ...
                <div class="col-6 col-md-6 col-lg-3">
                    ...
                    <a href="" class="">
                        <img src="assets/images/google-play.png" class="mt-3" alt="" height="35">
                    </a>
                </div>
            </div>
		</footer>
        <section class="bottom-footer">
            <div class="row">
                <div class="col-md-4 text-center text-md-left">
                    ...
                    <p>
                        কপিরাইট © ২০২০ সর্বস্বত্ব সংরক্ষিত <br>
                ...
                <div class=" text-center text-md-left col-md-4">
                    <img src="assets/images/footer-logo-new.png" alt="a2i" width="75%">
                </div>
                ...
                <div class="text-center text-md-right col-md-4">
                    ...
                    <p>
                        <a href="" target="_blank">আইইসিএল</a> এবং
                        <a href="" target="_blank"> সিএসটি</a>
